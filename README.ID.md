...
Lihat [GNU General Public License](https://github.com/rajput-abdullah/blob/main/LICENSE) untuk lebih detail.
...
Kontribusi dipersilakan. Tolong baca [pedoman kontribusi](https://github.com/rajput-abdullah/blob/main/CONTRIBUTING.md) kami sebelum berkontribusi.

## Mengalami masalah?

Lihat pada beberapa [masalah umum](https://github.com/rajput-abdullah/wiki/Common-Issues) yang mungkin kamu alami. Jika masalahmu tidak ada disana, silakan untuk membuka Issue :)
...
Untuk membaca seluruh daftar perubahan kunjungi [halaman wiki](https://github.com/rajput-abdullah/wiki/Changelog)